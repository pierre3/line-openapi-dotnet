...
namespace Line.OpenApi.Liff.DependencyInjection;
...
/// The implementation mirrors the same-named extension in Line.OpenApi.Messaging (the only difference
/// being the single host).
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>Name of the named HttpClient used internally by DI.</summary>
    public const string HttpClientName = "Line.OpenApi.Liff";
    ...
    /// the injection path that avoids a Line.OpenApi.Liff -> Line.OpenApi.ChannelAccessToken dependency.
    /// </summary>
    public static IServiceCollection AddLineLiff(
        this IServiceCollection services,
