...
namespace Line.OpenApi.Messaging.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
    ...
    public const string HttpClientName = "Line.OpenApi.Messaging";
    ...
    /// the injection path that avoids a Line.OpenApi.Messaging -> Line.OpenApi.ChannelAccessToken dependency.
    /// </summary>
    public static IServiceCollection AddLineMessaging(
        this IServiceCollection services,
