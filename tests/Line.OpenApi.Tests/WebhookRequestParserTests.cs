...
// assembly (Line.OpenApi.Tests) because other tests may pollute ParseNodeFactoryRegistry.DefaultInstance. That self-containment
...
// independent assembly Line.OpenApi.Messaging.Webhook.IsolationTests (references only Webhook = a clean registry).
